...
public final class CalcAverageTolledTripLength implements LinkEnterEventHandler, PersonArrivalEventHandler, VehicleEntersTrafficEventHandler, VehicleLeavesTrafficEventHandler {
    ...
    @Inject
	public CalcAverageTolledTripLength(final Scenario scenario, final RoadPricingScheme scheme, EventsManager events) {
		this.scheme = scheme;
	...
	public void handleEvent(final LinkEnterEvent event) {
		...
		Cost cost = this.scheme.getLinkCostInfo(event.getLinkId(), event.getTime(), driverId, event.getVehicleId(), leg.getMode());
