 ...
 *                                                                         *
 * *********************************************************************** */
package org.matsim.roadpricingV2.run;
...
import org.matsim.roadpricingV2.RoadPricingConfigGroup;
import org.matsim.roadpricingV2.RoadPricingModule;
import org.matsim.roadpricingV2.RoadPricingSchemeUsingTollFactor;
import org.matsim.roadpricingV2.TollFactor;
...
public class RunRoadPricingUsingTollFactorExample {
	...
	public static void main(String[] args) {
		...
		TollFactor tollFactor = new TollFactor(){
			@Override public double getTollFactor(Id<Person> personId, Id<Vehicle> vehicleId, Id<Link> linkId, double time, String mode) {
