...
/**
 *
 * @author nagel, mrieser, michaz, VK
 */
public interface RoadPricingScheme {
	...
	public static final String TOLL_TYPE_MODE = "mode";
	 ...
	 */
	public RoadPricingSchemeImpl.Cost getLinkCostInfo(final Id<Link> linkId, final double time, Id<Person> personId, Id<Vehicle> vehicleId, String mode);
	 ...
	 * @return
	 */
	public RoadPricingSchemeImpl.Cost getTypicalLinkCostInfo(final Id<Link> linkId, final double time, String mode) ;
