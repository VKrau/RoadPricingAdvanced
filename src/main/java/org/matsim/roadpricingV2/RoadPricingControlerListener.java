...
class RoadPricingControlerListener implements StartupListener, IterationEndsListener, ShutdownListener {
	...
	public void notifyIterationEnds(final IterationEndsEvent event) {
		...
		log.info("The sum by legs: ");
		for(Map.Entry<String, ModeTollInfo> entry : this.calcPaidToll.getLegTolls().entrySet()) {
			log.info("mode: "+entry.getKey() + " amount: "+entry.getValue().getAmount());
		}
	}
