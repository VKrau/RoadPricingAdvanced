...
public final class RoadPricingConfigGroup extends ReflectiveConfigGroup {
	...
	private static final String FREE_MOVEMENT_INSIDE_CORDON = "freeMovementInsideCordon";
	private String tollLinksFile = null;
	private String freeMovementInsideCordon = null;
	...
	@StringGetter(FREE_MOVEMENT_INSIDE_CORDON)
	public String getFreeMovementInsideCordon() {
		return this.freeMovementInsideCordon;
	}
	@StringSetter(FREE_MOVEMENT_INSIDE_CORDON)
	public void setFreeMovementInsideCordon(String freeMovementInsideCordon) {
		this.freeMovementInsideCordon = freeMovementInsideCordon;
	}
